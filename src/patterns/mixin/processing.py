...
from src.patterns.strategy.processing.relationship_processing import OffersProcessingStrategy, RequiresProcessingStrategy, \
...
class ProcessingMixin:
    ...
    def __init__(self, component_name: ComponentName):
        if component_name == ComponentName.STUDY_PROGRAM:
            ...
            self.processing_strategy = OffersProcessingStrategy()
        elif component_name == ComponentName.PREREQUISITE:
            self.processing_strategy = RequiresProcessingStrategy()
